...
system("wget https://raw.githubusercontent.com/Leo-Poon-Lab/Parsing-SnpEff/main/Parse_SnpEff.r -P ./helper/ -nc")
...
annotate_snpeff <- function(files_vcf, mc.cores=8){
	genome <- "NC_045512.2"
	df_out <- mclapply(files_vcf, function(x){
		tmp <- readLines(x)
